...
namespace SmartBook.Persistence.Repositories.Implementation
{
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        public bool Actualizar(Usuario usuario)
        {
            ...
            command.Parameters.AddWithValue("@password", usuario.Password);
            command.Parameters.AddWithValue("@correo", usuario.Email);
            command.Parameters.AddWithValue("@fecha_actualizacion", usuario.fecha_actualizacion.ToString(FORMATO_FECHA));
        ...
        public IEnumerable<ConsultarUsuarioReponse> ConsultarPorNombre(string nombreCompleto, RolUsuario? rolUsuario)
        {
            using (var conexion = new MySqlConnection(_connectionString))
            {
                ...
                using (var cmd = new MySqlCommand(Sql, conexion))
                {
                    ...
                    cmd.Parameters.AddWithValue("@rol", rolUsuario.HasValue ? rolUsuario.Value.ToString() : DBNull.Value);
