...
public class ClienteRepository : IClienteRepository
{
    ...
    public ConsultarClienteReponse Consultarid(string id_cliente)
    {
        ...
        using (var conexion = new MySqlConnection(_connectionString))
        {
            ...
            ,celular,fecha_creacion,fecha_actualizacion  FROM clientes WHERE id_cliente=@id_cliente";
    ...
    public bool Actulizar(string id, ActualizarClienteRequest request)
    {
        using (var conexion = new MySqlConnection(_connectionString))
        {
            ...
            using (var cmd = new MySqlCommand(Sql, conexion))
            {
                ...
                cmd.Parameters.AddWithValue("@fecha_actualizacion", DateTime.Now.ToString(FORMATO_FECHA));
